...
<div align="center" style="width:930px;">
    ...
    <div style="background-image:url(images/home_bg.jpg); width:930px; height:250px;"> <br/>
      <br/>
      <div><span style="font:40px 宋体; color:#FFF;line-height:60px;">2015年辽宁省教育软件大赛参赛作品</span></div>
      <div><span style="font:30px 宋体; color:#FFF;line-height:55px;">大连民族大学</span></div>
		...
		<table   >
			...
			<tr height="10">
				...
				<td><input type="text" value="${teacher.teacherId }" name="teacher.teacherId" id="teacherId"/></td>
				<td width="30%"></td>
			</tr>
			<tr height="10">
				<td width="40%"></td>
				<td width="10%" style="color:#FFF; font:10px 微软雅黑">密  码：</td>
				<td><input type="password" value="${teacher.password }" name="teacher.password" id="password"/></td>
				<td width="30%"></td>
			</tr>
