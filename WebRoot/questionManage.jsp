	...
	<div id="dlg" class="easyui-dialog" style="width: 570px;height: 350px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				<tr>
					<td>试题题目：</td>
					<td><input type="text" name="question.questions" id="questions" class="easyui-validatebox"     style="height: 20px; width: 350px; " required="true"/></td>
				</tr>
				<tr >
					<td>选项A：</td>
					<td><input type="text" name="question.optionA" id="optionA" class="easyui-validatebox" style="height: 20px; width: 350px; " required="true"/></td>
				</tr>
				<tr>
					<td>选项B：</td>
					<td><input type="text" name="question.optionB" id="optionB" class="easyui-validatebox" style="height: 20px; width: 350px; " required="true"/></td>
				</tr>
				<tr>	
					<td>选项C：</td>
					<td><input type="text" name="question.optionC" id="optionC" class="easyui-validatebox" style="height: 20px; width: 350px; " required="true"/></td>
				</tr>
				<tr>
					<td>选项D：</td>
					<td><input type="text" name="question.optionD" id="optionD" class="easyui-validatebox" style="height: 20px; width: 350px; " required="true"/></td>
				</tr>
				<tr>		
					<td>正确答案：</td>
					<td><input type="text" name="question.answer" id="answer" class="easyui-validatebox" style="height: 20px; width: 350px; " required="true"/></td>
				</tr>
				<tr>
					<td>分值：</td>
					<td><input type="text" name="question.score" id="score" class="easyui-validatebox" style="height: 20px; width: 350px; " required="true"/></td>
				</tr>
			</table>
		</form>
	</div>
