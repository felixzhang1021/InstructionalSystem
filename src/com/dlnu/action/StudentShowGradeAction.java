...
@Scope("prototype")
@Namespace("/")
@Action(value="studentshowgrade",results={@Result(name="success",type="redirect",location="/showGrade.jsp")})
public class StudentShowGradeAction extends ActionSupport implements ServletRequestAware{
	/**
	 * 
	 */
	...
	public String execute() throws Exception {
		...
		List<Grade> studentGradeList=  showGradeService.studentShowGrade(stuId); 
