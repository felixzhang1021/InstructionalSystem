...
@Scope("prototype")
@Namespace("/")
@Action(value="showhistorypaperquestion",results={@Result(name="success",type="redirect",location="/showHistoryQuestion.jsp")})
public class ShowHistoryTestQuestionAction extends ActionSupport implements ServletRequestAware{
	/**
	 * 
	 */
	...
	public String execute() throws Exception {
		...
		for(int i=0;i<testQuestionList.size();i++){
			...
			jsonObject.put("optionC", testQuestion.getOptionC());
     		...
     		jsonObject.put("answer", testQuestion.getAnswer());
