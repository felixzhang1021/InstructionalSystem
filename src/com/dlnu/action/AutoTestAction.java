...
@Scope("prototype")
@Namespace("/")
@Action(value="autotest",results={@Result(name="success",type="redirect",location="/autoTest.jsp")})
public class AutoTestAction extends ActionSupport implements ServletRequestAware{
	/**
	 * 
	 */
