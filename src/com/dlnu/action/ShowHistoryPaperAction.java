...
@Scope("prototype")
@Namespace("/")
@Action(value="showHistoryPaper",results={@Result(name="success",type="redirect",location="/showHistoryPaper.jsp")})
public class ShowHistoryPaperAction extends ActionSupport implements ServletRequestAware{
	/**
	 * 
	 */
